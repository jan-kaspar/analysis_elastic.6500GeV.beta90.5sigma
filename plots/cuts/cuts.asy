...
real lim_x_low[] = { -200, -400, -1000, -1000, -15, -15, -200, -600 };
real lim_x_high[] = { +200, +400, +1000, +1000, +15, +15, +200, +600 };

real lim_y_low[] = { -200, -400, -0.8, -0.8, -0.5, -0.5, -0.5, -4 };
real lim_y_high[] = { +200, +400, +0.8, +0.8, +0.5, +0.5, +0.5, +4 };
